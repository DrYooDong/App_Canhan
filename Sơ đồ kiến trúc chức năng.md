...
| [components/astrology.js](file:///i:/Drive%20c%E1%BB%A7a%20t%C3%B4i/apps/App_Canhan/components/astrology.js) | **Tử Vi & Vận Hạn Hub**: <br>• Sub-tabs: Lá số Tử Vi, Time-Machine 60 Năm, Nhiệm vụ Cải mệnh, Thực dưỡng sáng, Trợ lý sức khỏe, Nhịp giờ hoàng đạo, Cân bằng 6 trụ cột, Tổng quan cuộc đời. | Hub điều hành chính về Tử Vi. |
| [components/timemachine.js](file:///i:/Drive%20c%E1%BB%A7a%20t%C3%B4i/apps/App_Canhan/components/timemachine.js) | **Trình Mô Phỏng Time-Machine Cuộc Đời**: <br>• Timeline Slider 20–80 tuổi & Energy Heatmap Strip.<br>• Selected Year Dashboard (LES Score, 4 Trụ cột, Sao Lưu, Mai Hoa Hexagram).<br>• Life Milestone Pinning (Ghim mốc đời thực & Đánh giá chiến lược AI). | Nằm trong sub-tab **Time-Machine 60 Năm** của Tử Vi Hub. |
...
| `Mô Phỏng Time-Machine Cuộc Đời.md` | `data/astrology_logic.js`, `components/timemachine.js`, `components/astrology.js` | ✅ Completed |
